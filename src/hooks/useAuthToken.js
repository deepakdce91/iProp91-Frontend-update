    ...
    if (!token) {
      ...
      if (
        !(
          ...
          location.pathname.includes("/services/listing") ||
          location.pathname.includes("/services/safe") ||
          location.pathname.includes("/services/owners-club") ||
          location.pathname.includes("/services/concierge")
        )
      ) {
