...
export default function FiltersPanel({
  ...
  const [selectedLocalities, setSelectedLocalities] = useState(() => {
    if (!initialFilters.localities) {
      return [];
    }
    if (Array.isArray(initialFilters.localities)) {
      return initialFilters.localities;
    }
    if (typeof initialFilters.localities === "string") {
      return initialFilters.localities.split(",");
    }
    return [];
  });
  ...
  const [selectedAmenities, setSelectedAmenities] = useState(() => {
    ...
    if (typeof initialFilters.amenities === "string") {
