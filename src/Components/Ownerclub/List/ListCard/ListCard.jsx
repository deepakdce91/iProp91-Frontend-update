export default function ListCard({name, message, time, unread}) {
    ...
    return (
        <>
            <div className="flex items-start p-3 my-1 bg-white border-2 hover:bg-gold rounded-lg items-center messagelink" onClick={handleChatlink}>
                <div className="mr-3">
                    {/* Avatar */}
                ...
                <div className="ml-3 flex flex-col" style={{alignItems:'end'}}>
