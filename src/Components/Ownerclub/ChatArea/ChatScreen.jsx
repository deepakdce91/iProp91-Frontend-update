...
//   return (
//     <div className="min-h-screen  px-2 md:px-10 lg:px-[68px]">
//       {/* <!-- component --> */}
//       <div className="flex gap-4 rounded-xl border-[1px] min-h-screen lg:p-5 border-gold overflow-hidden relative mt-[86px] ">
//         {/* <!-- Sidebar --> */}
//         <div
...
//         >
//           {/* <!-- Sidebar Header --> */}
//           <header className="p-4 border-b flex-col border-gray-300 flex justify-between rounded-xl  bg-gold/60 text-black">
//             <h1 className="text-2xl font-semibold">Conversations</h1>
//             <div className="flex px-4 py-3 mt-2 rounded-md border-[1px] border-gold  overflow-hidden max-w-md  font-[sans-serif]">
//               <svg
...
//                 }}
//                 placeholder="Search" 
//                 className="w-full outline-none bg-transparent text-black text-sm placeholder-black"
//               />
//             </div>
//           </header>

//           {/* <!-- Contact List --> */}
//           <div className="overflow-y-auto    rounded-xl p-3 mb-9 pb-20">
...
//                   : "text-white bg-black/80 rounded-xl"
//               }  p-4  `}
//             >
//               {currentGroupData && (
