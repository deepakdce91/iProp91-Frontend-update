export default function PropCard () {
    return (
      <>
        <div class="bg-white drop-shadow-2xl  border-transparent border-b-4 border-[1px] hover:border-simple hover:border-b-4 hover:border-[1px] p-4 rounded-xl w-80 ">
          <img
          ...
          <div class="flex flex-row justify-between mt-4 gap-2">
            <button class=" w-full text-[14px] bg-slate-100 py-2 px-4 rounded-lg">
              Available
            </button>
          </div>
        </div>
