...
export default function FinanceAssitance (){
    return (
      <>
        <div className="mt-8  ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 flex  flex-col ">
          <div className="hidden lg:!grid bg-primary lg:h-[73vh]  relative grid-cols-[40%,60%] gap-6 py-16 px-20  w-full">
            <div className="flex flex-col relative z-20">
              <p className="text-white text-4xl">Finance</p>
              <p className="text-white text-4xl mb-4">Assistance</p>
              <textarea
            ...
            <div className="flex flex-col mt-10 gap-10 relative z-20 text-white">
              ...
              <div className="flex justify-around w-2/3 bg-[#ffffff25] relative py-2.5 rounded-lg ml-48 ">
                <img
                  alt="star"
                  loading="lazy"
                  width="12"
              ...
              <div className="flex justify-around w-2/3 bg-[#ffffff25] relative ml-20 py-2.5 rounded-lg">
                <img
                  alt="star"
                  loading="lazy"
                  width="12"
          ...
          <div className="lg:!hidden relative bg-primary flex  flex-col gap-3 py-16 px-6 w-full">
            ...
            <div
              className="w-full relative z-20 mt-7 text-white"
              role="region"
