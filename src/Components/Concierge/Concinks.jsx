    ...
    <>
      <div className="flex w-full lg:hidden px-8 gap-2">
        <div className="relative block text-left z-40" ref={dropdownRef}>
          ...
          {isOpen && (
            <div className="absolute right-0  w-48 origin-top-right bg-white border border-black/80 divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5">
              <div className="py-1">
