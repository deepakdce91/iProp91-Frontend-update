        ...
        <div className="  p-4 md:p-10 w-full justify-center flex items-center  ">
          <div className="flex flex-col lg:flex-row items-center justify-center gap-10 mt-10 md:mt-0">
                ...
                <div className="flex w-full flex-col  justify-center items-center">
                  <div className="w-full   rounded-full overflow-hidden flex items-center justify-center">
                    <img
                      ...
                      alt="profile"
                      className="relative inline-block h-[150px] w-[150px] !rounded-full  object-cover object-center border-2 border-yellow-600 p-1"
                    />
                  </div>
                  <div className="w-full  flex flex-col items-center justify-center">
                    <label
                      className="text-gray-900 font-[500] my-2  dark:text-white"
                  ...
                  <div className="w-full flex flex-col justify-center items-center my-1">
                    ...
                    <input
                      ...
                      className="mt-1 block cursor-pointer w-full text-gray-500  border-2 rounded-3xl file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-yellow-50 file:text-yellow-700 hover:file:bg-yellow-100"
            ...
            <div className="flex-1 w-full">
              <div className="flex flex-col    px-2 w-full">
                ...
                <div className="w-full">
                  <div className={`w-full my-2 font-sm`}>
                    <label className="text-gray-900 font-[500]   dark:text-white">
                      Phone
                    </label>
                    <input
                      type="text"
              ...
              <div className="flex flex-col  my-1 mt-3 px-2 justify-center  w-full items-end">
                <div className="flex flex-col lg:flex-row justify-center items-center w-full gap-3">
                  <div className="w-full ">
                    <LabelInput
                      label={"New Password"}
                      type={"password"}
                ...
                <div className="w-full lg:w-[50%] flex my-2">
                  <GoldButton
