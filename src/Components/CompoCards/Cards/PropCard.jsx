export default function PropCard ({props}) {
    return (
      <>
        <div className="bg-white drop-shadow-2xl  border-transparent border-b-4 border-[1px] hover:border-simple hover:border-b-4 hover:border-[1px] p-4 rounded-xl w-72 ">
          <img
          ...
          <div className="flex flex-row justify-between mt-4 gap-2">
            <button className=" w-full text-[14px] hover:shadow-lg hover:shadow-gold border-b-[4px] border-b-gold  bg-black text-white py-2 px-4 rounded-full">
