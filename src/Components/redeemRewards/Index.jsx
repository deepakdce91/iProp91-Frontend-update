      ...
      {isLoggedIn ? (
        ...
        <div className="w-full min-h-screen flex flex-col lg:gap-1 mt-20 md:mt-0 bg-gray-100">
          ...
          <div className="w-full flex-col bg-gray-100 flex items-center">
            ...
            <div className="flex-row flex flex-wrap my-6 shadow-md border border-yellow-600/30 rounded-lg w-full justify-start m-4">
              {redeemRewards.length > 0 &&
                redeemRewards.map((item, index) => {
                  return (
                    <div
                      key={index}
                      className="w-64 border border-yellow-600/50 rounded-lg m-3 bg-white shadow-lg flex flex-col"
                    >
                        ...
                        <div className="mb-2 flex items-center justify-between">
                          ...
                          <div className="text-yellow-600 w-28 text-right text-lg font-semibold">
                            ...
                            {item.discountType === "percentage" ? (
                              ...
                              <BiCoin className="inline" />
                            )}
                          </div>
                        </div>
                        <p className="text-gray-800 leading-normal font-light flex-1">
                          {item.description}
                        </p>
                        <button
                ...
                {activeVouchers.length > 0 ? (
                    ...
                    >
                      <div className="p-4 flex flex-col items-center">
                        ...
                        <p className="text-gray-400 text-sm mt-3 text-center">
                          Valid until:{" "}
                          {new Date(
                            new Date(voucher.issuedDate).setFullYear(
                              new Date(voucher.issuedDate).getFullYear() + 1
                            )
                          ).toLocaleDateString()}
                        </p>
                  ...
                  <div className="w-full flex flex-col items-center justify-center py-8 px-4 text-gray-400">
                    ...
                    <p className="text-center text-sm mt-1">
                      Redeem your points to get exclusive offers!
                    </p>
                  </div>
                )}
              </div>
          ...
          <div className="flex relative text-black  pb-28 px-3 md:px-8 bg-white min-h-screen lg:px-32 pt-5 md:pt-10">
            <div className="flex flex-col md:flex-row justify-center h-full lg:items-start mt-10">
              <div className="md:w-1/3 flex flex-col gap-3">
                ...
                <p className="text-lg">
                  Learn about our rewards program and how you can earn points to
                  redeem exclusive vouchers and discounts.
                </p>
              </div>
